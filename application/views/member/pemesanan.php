<div ng-app="app" ng-controller="pemesananController">
  <div class="row d-flex flex-row-reverse" style="margin-bottom:12px;">
    <a href="" class="button" data-toggle="modal" data-target="#modal-warning" ng-click="itemPesanan=[]">Booking</a>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card card-warning">
      <div class="card-header" style="background-color:grey">
        <h3 class="card-title"> <font color="white">Data Pemesanan</font></h3>
        </div>
        <div class="card-body">
          <nav>
