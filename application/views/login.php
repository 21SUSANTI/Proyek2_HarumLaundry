...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    <div class="login-logo">
      <h3><b>SISTEM INFORMASI <BR>HARUM LAUNDRY</h3></b>
	      </div>
    <!-- /.login-logo -->
    <div class="card">
...
<body class="hold-transition login-page" style="background:url(images/4.JPG)
...
echo "Anda mengakses hari ini tanggal    " . date("d-m-Y ") . " Pukul    " . date(" H:i:s") . "<br>";
?></b>
</html>